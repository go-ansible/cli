module github.com/go-ansible/cli

go 1.26.4

require (
	github.com/go-ansible/inventory v0.4.0
	github.com/go-ansible/modules v0.43.0
	github.com/go-ansible/playbook v0.19.0
...
require (
	...
	github.com/go-ansible/template v0.13.0 // indirect
