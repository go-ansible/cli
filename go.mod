...
require (
	...
	github.com/go-ansible/playbook v0.2.3
	github.com/go-ansible/vault v0.1.0
...
require (
	...
	github.com/go-ansible/template v0.1.0 // indirect
	github.com/go-ansible/vars v0.1.1 // indirect
